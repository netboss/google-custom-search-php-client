...
require_once(dirname(__FILE__).'/../../../../../src/Google/CustomSearch/Response/Result/PageMap.php');

class Google_CustomSearch_Response_Result_PageMapTest extends PHPUnit_Framework_TestCase
{
    // ------------------------------------------------------
    // Tests
    // ------------------------------------------------------
    ...
    public function testConstruct()
    {
        ...
        $pageMap = new Google_CustomSearch_Response_Result_PageMap($pageMapData);
